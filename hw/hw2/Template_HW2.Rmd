...
The multivariate model evaluates the impact of two parameters on
...
We will analyse one by one the parameters:
...
\[
\begin{equation}
  \frac{\hat\beta_1 - \beta_1}{\hat\sigma_{\beta_1}} \sim t_{df} .
  \tag{2.10}
\end{equation}
\]
